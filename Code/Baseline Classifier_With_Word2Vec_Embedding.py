...
# Word2Vec with 100 Dimension

from gensim.models import Word2Vec

# Create a list of lists of tokens for the Word2Vec model
...
vector_size = 100  # Match the size of the Word2Vec embeddings

X_vectors = []
for text in X:
    sentence_vector = get_sentence_vector(text, word2vec_model, vector_size)
...
print('Classfier Running with 100 Word2Vec dimension ....')
...
# Train the Word2Vec model with 300 dimension
...
vector_size = 300  # Match the size of the Word2Vec embeddings
...
print('Classfier Running with 300 Word2Vec dimension ....')
